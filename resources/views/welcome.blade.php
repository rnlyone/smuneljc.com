            ...
            <div class="row">
              <div class="col-md-5 my-auto">
                <div class="banner_title">
                  <h1>Ekskul Jepang Tidak Biasa.</h1>
                  <p>
                    Smunel Japanese Community.
                  </p>
                  <a href="#" class="btn btn_md_primary effect-letter rounded-8 bg-blue c-white">Daftar</a>
              ...
              <div class="col-md-7">
                <img class="ill_05" src="assetshome/img/agency/itsukibanner.png" />
              </div>
            </div>
          </div>
        </section>
            ...
            <div class="row">
              ...
              <div class="col-lg-4 emo">
                <div class="gq_item ill_item">
                  ...
                  <img class="img-fluid ill_sec" src="assetshome/img/agency/Update.png" />
                  <div class="title_sections">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-5 ml-auto">
                          <div class="pro_agency">
                            <img src="assetshome/img/agency/banneritsuha.png" />
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div class="row">
                  <div class="col-md-5">
                    <div class="item_logo" data-aos="fade-up" data-aos-delay="0">
                      <img src="assetshome/img/logos/xperience.png" />
                      <p class="c-gray">
                  ...
                  <div class="col-md-5 ml-auto">
                    <div class="item_logo" data-aos="fade-up" data-aos-delay="100">
                      <img src="assetshome/img/logos/aust.png" />
                      <p class="c-gray">
                  ...
                  <div class="col-md-5">
                    <div class="item_logo" data-aos="fade-up" data-aos-delay="200">
                      <img src="assetshome/img/logos/sitecore.png" />
                      <p class="c-gray">
                ...
                <div class="row">
                  <div class="col-md-6 item pr-sm-5 mb-3 mb-sm-5">
                    <div class="item_pro" data-aos="fade-up" data-aos-delay="0">
                      <div class="icon_t">
                        <img src="assetshome/img/icons/Employee.svg" />
                      </div>
                  ...
                  <div class="col-md-6 item pr-sm-5 mb-3 mb-sm-5">
                    <div class="item_pro" data-aos="fade-up" data-aos-delay="100">
                      <div class="icon_t">
                        <img src="assetshome/img/icons/Binocular.svg" />
                      </div>
                  ...
                  <div class="col-md-6 item pr-sm-5 mb-3 mb-sm-5">
                    <div class="item_pro" data-aos="fade-up" data-aos-delay="200">
                      <div class="icon_t">
                        <img src="assetshome/img/icons/Shield-check.svg" />
                      </div>
                  ...
                  <div class="col-md-6 item pr-sm-5">
                    <div class="item_pro" data-aos="fade-up" data-aos-delay="300">
                      <div class="icon_t">
                        <img src="assetshome/img/icons/Door-open.svg" />
                      </div>
          ...
          <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-lg-4">
                <a href="#" class="item_ig item_mywork">
                  <div class="mg_img">
                    <video class="item_pic" playsinline muted autoplay loop src="assetshome/img/agency/rezz-jamming_2.mp4"></video>
                  </div>
                  <div class="info_work">
                    <h4>Healto — Evolving Healthcare Systems.</h4>
                    <p>
              ...
              <div class="col-lg-8">
                <a href="#" class="item_ig item_mywork">
                  <div class="mg_img">
                    <img class="item_pic" src="assetshome/img/agency/78970654.png" />
                  </div>
                  <div class="info_work">
                    <h4>
                      Spring Labs — Disrupting How Financial Info Is Shared.
          ...
          <div class="container">
            <div class="row justify-content-between">
              <div class="col-lg-5 mb-4 mb-lg-0">
                <div class="item_mmon">
                  <div class="profile_user">
                    <img src="assetshome/img/persons/14.png" />
                    <div class="categ">
              ...
              <div class="col-lg-5">
                <div class="item_mmon">
                  <div class="profile_user">
                    <img src="assetshome/img/persons/13.png" />
                    <div class="categ">
              ...
              <form class="form-row">
                <div class="col-md-11 form-group subscribebtn">
                  <div class="item_input">
                    <input type="email" class="form-control rounded-8" id="exampleInputEmail1" placeholder="Enter email address" aria-describedby="emailHelp" />
    ...
    <div aria-live="polite" aria-atomic="true" class="d-flex justify-content-center align-items-center">
      <div class="toast toast_demo" id="myTost" role="alert" aria-live="assertive" aria-atomic="true" data-animation="true" data-autohide="false">
        <div class="toast-body">
          ...
          <h5>Konnichiwa 👋</h5>
          <p>Ayo Gabung SJC <a href="#">Join us</a></p>
        </div>
      </div>
    </div>
    <!-- End. Toasts -->
